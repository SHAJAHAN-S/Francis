...
const quickLinks = [
  ...
  { icon: <FiDollarSign size={24} />, label: 'Fee Structure', desc: 'View class-wise fees', path: '/admissions#fees', color: 'from-green-500 to-emerald-600' },
  { icon: <FiCalendar size={24} />, label: 'Academic Calendar', desc: '2024-25 calendar', path: '/academics#curriculum', color: 'from-purple-500 to-violet-600' },
  ...
  { icon: <FiExternalLink size={24} />, label: 'Result Portal', desc: 'Check exam results', path: '/academics', color: 'from-cyan-500 to-teal-600' },
];
