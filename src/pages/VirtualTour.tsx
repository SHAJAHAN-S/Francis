...
const areas = [
  { id: 1, name: 'Main Entrance & Campus', desc: 'The welcoming front gate and campus grounds with lush greenery.', color: 'from-blue-400 to-blue-600', image: '/virtual/entrance.jpg' },
  { id: 2, name: 'Smart Classrooms', desc: 'Air-conditioned rooms equipped with projectors and digital boards.', color: 'from-purple-400 to-purple-600', image: '/virtual/classroom.jpg' },
  { id: 3, name: 'Science Laboratories', desc: 'Well-equipped Physics, Chemistry, and Biology labs for hands-on learning.', color: 'from-green-400 to-green-600', image: '/virtual/lab.jpg' },
  { id: 4, name: 'Computer Lab', desc: '40+ computers with high-speed internet for digital literacy.', color: 'from-cyan-400 to-cyan-600', image: '/virtual/computer-lab.jpg' },
  { id: 5, name: 'Library & Reading Room', desc: '10,000+ books, journals, and e-resources in a serene environment.', color: 'from-amber-400 to-amber-600', image: '/virtual/library.jpg' },
  { id: 6, name: 'Sports Ground', desc: 'Expansive playground for cricket, football, kabaddi, and athletics.', color: 'from-red-400 to-red-600', image: '/virtual/sports.jpg' },
  { id: 7, name: 'Chapel', desc: 'Beautiful chapel for daily prayers and spiritual gatherings.', color: 'from-indigo-400 to-indigo-600', image: '/virtual/chapel.jpg' },
  { id: 8, name: 'Auditorium', desc: 'Multi-purpose hall for events, cultural programs, and assemblies.', color: 'from-pink-400 to-pink-600', image: '/virtual/auditorium.jpg' },
];
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mt-10">
            ...
            <div className="lg:col-span-2">
              <div className={`aspect-video rounded-2xl bg-gradient-to-br ${areas[active].color} flex items-center justify-center relative overflow-hidden shadow-lg`}>
                ...
                <div className="absolute bottom-4 right-4 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1.5 text-xs text-white font-label flex items-center gap-2">
                  <button onClick={() => setIsPanoramaOpen(true)} className="text-white underline">View 360°</button>
                  <span className="text-xs">or</span>
                  <button onClick={() => setIsVideoModalOpen(true)} className="text-white underline">Watch Video</button>
                </div>
              </div>
        ...
        {isPanoramaOpen && (
          <PanoramaViewer src={areas[active].image} onClose={() => setIsPanoramaOpen(false)} />
        )}
      </main>
    </>
  );
